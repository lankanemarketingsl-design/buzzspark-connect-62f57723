            ...
            <section className="mb-12">
              <div className="p-8 rounded-2xl bg-primary/5 border border-primary/20 text-center">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  <a data-selected-service="Hotel Marketing" href="https://wa.me/94771976351?text=Hi%20Buzz%20Connect%2C%20I%20want%20to%20discuss%20hotel%20marketing%20packages." target="_blank" rel="noopener noreferrer">
