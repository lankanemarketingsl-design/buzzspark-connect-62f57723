      ...
      <article className="max-w-4xl mx-auto space-y-12">
        ...
        <section className="text-center bg-gradient-to-r from-primary to-primary/80 rounded-2xl p-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a data-selected-service="Email Marketing" href="https://wa.me/94771437707?text=Hi%20Buzz%20Connect%2C%20I%27m%20interested%20in%20e-commerce%20email%20marketing%20campaigns." target="_blank" rel="noopener noreferrer"><Button variant="hero" size="lg" className="text-base">Chat on WhatsApp <ArrowRight className="ml-1" /></Button></a>
          </div>
        </section>
      </article>
